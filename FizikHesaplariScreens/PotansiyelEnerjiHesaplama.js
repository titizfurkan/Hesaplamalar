...
export default class PotansiyelEnerjiHesaplama extends Component {
  constructor(props) {
    super(props);
    this.state = {
      input1: "",
  ...
  sonucMethod() {
    ...
    var sonuc = number1 * number2 * 9.80665;
    ...
    return (
      <SafeAreaView style={styles.container}>
        <View style={styles.contentWrapper}>
          ...
          <Text style={styles.sampleText}>Potansiyel Enerji : {this.state.sonuc}
          </Text>
        </View>
      </SafeAreaView>
    );

...
export default class KinetikEnerjiHesaplama extends Component {
  constructor(props) {
    super(props);
    this.state = {
      input1: "",
  ...
  sonucMethod() {
    ...
    var sonuc = (number1 * number2 * number2) / 2;
    ...
    return (
      <SafeAreaView style={styles.container}>
        <View style={styles.contentWrapper}>
          ...
          <Text style={styles.sampleText}> Kinetik Enerji : {this.state.sonuc}</Text>
        </View>
      </SafeAreaView>
    );
  }

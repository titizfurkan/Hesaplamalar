...
export default class KombinasyonHesaplama extends Component {
  constructor(props) {
    super(props);
    this.state = {
      input1: "",
  ...
  sonucMethod() {
    ...
    var sonuc1 = cevap3 * cevap2;
    var sonuc = cevap / sonuc1; 
    ...
    return (
      <SafeAreaView style={styles.container}>
        <View style={styles.contentWrapper}>
          ...
          <TextInput
            style={styles.input}
            placeholder="Toplam Eleman Sayısı (n)"
            onChangeText={(text) => {
              this.setState({
                input1: text,
              });
          ...
          <TextInput
            style={styles.input}
            placeholder="Seçilecek Eleman Sayısı (r)"
            onChangeText={(text) => {
              this.setState({
                input2: text,
              });
          ...
          <Text style={styles.sampleText}> C(n, r) : {this.state.sonuc}</Text>
        </View>
      </SafeAreaView>
    );
  }

...
export default class GeometrikDagilimHesaplama extends Component {
  constructor(props) {
    super(props);
    this.state = {
      input1: "",
  ...
  sonucMethod() {
    ...
    var sonuc = (1 - number2)^number1 * number2;
    ...
    return (
      <SafeAreaView style={styles.container}>
        <View style={styles.contentWrapper}>
          ...
          <TextInput
            style={styles.input}
            placeholder="Başarısız Deneme Sayısı"
            onChangeText={(text) => {
              this.setState({
                input1: text,
              });
          ...
          <Text style={styles.sampleText}> P : {this.state.sonuc}</Text>
        </View>
      </SafeAreaView>
    );
  }

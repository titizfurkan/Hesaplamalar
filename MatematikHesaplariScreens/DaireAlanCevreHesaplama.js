...
export default class DaireAlanCevreHesaplama extends Component {
  constructor(props) {
    super(props);
    this.state = {
      input1: "",
  ...
  sonucMethod() {
    ...
    const cap = number1;
    const cevre = 2 * 3.14 * number1;
    const alan = 3.14 * number1 * number1;
    ...
    return (
      <SafeAreaView style={styles.container}>
        <View style={styles.contentWrapper}>
          ...
          <Text style={styles.sampleText}> Çap : {this.state.cap}</Text>

...
export default class HataYuzdesiHesaplama extends Component {
  constructor(props) {
    super(props);
    this.state = {
      input1: "",
  ...
  sonucMethod() {
    ...
    var sonuc = (number1 - number2) / number1 * 100;
    ...
    return (
      <SafeAreaView style={styles.container}>
        <View style={styles.contentWrapper}>
          ...
          <Text style={styles.sampleText}> Sonuç %: {this.state.sonuc}</Text>
        </View>
      </SafeAreaView>
    );
  }

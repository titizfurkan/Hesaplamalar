...
export default class YatirimSermayeGetirisi extends Component {
  constructor(props) {
    super(props);
    this.state = {
      input1: "",
  ...
  sonucMethod() {
    ...
    const number4 = parseFloat(this.state.input4);

    var sonuc = ((number1 * (1- (number2/100))) / (number3 + number4));
    sonuc = sonuc * 100;
    ...
    return (
      <SafeAreaView style={styles.container}>
        <View style={styles.contentWrapper}>
          ...
          <Text style={styles.sampleText}> ROIC % : {this.state.sonuc}</Text>
        </View>
      </SafeAreaView>
    );
  }

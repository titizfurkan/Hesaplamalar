...
export default class FaizVergiKarHesaplama extends Component {
  constructor(props) {
    super(props);
    this.state = {
      input1: "",
        ...
        <View style={styles.contentWrapper}>
          ...
          <View style={styles.header}>
            <Text style={{ fontWeight: "500", fontSize: 16, marginBottom: 20 }}>
              Faiz Vergi Öncesi Kar Hesaplama
            </Text>
          </View>
          <TextInput
            style={styles.input}
            placeholder="Toplam Gelir"
            onChangeText={(text) => {
              this.setState({
                input1: text,
              });
          ...
          <TextInput
            style={styles.input}
            placeholder="Faaliyet Giderleri"
            onChangeText={(text) => {
              this.setState({
                input2: text,
              });
          ...
          <Text style={styles.sampleText}> FVÖK : {this.state.sonuc}</Text>
        </View>
      </SafeAreaView>
    );
  }

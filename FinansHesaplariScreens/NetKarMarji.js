...
export default class NetKarMarji extends Component {
  constructor(props) {
    super(props);
    this.state = {
      input1: "",
  ...
  sonucMethod() {
    ...
    var sonuc = number1 / number2 * 100;
    sonuc = (sonuc.toFixed(5))
    ...
    return (
      <SafeAreaView style={styles.container}>
        <View style={styles.contentWrapper}>
          ...
          <Text style={styles.sampleText}> Kar Yüzdesi % : {this.state.sonuc}</Text>
        </View>
      </SafeAreaView>
    );
  }

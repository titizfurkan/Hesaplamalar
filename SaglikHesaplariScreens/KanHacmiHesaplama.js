...
export default class KanHacmiHesaplama extends Component {
  constructor(props) {
    super(props);
    this.state = {
      input1: "",
  ...
  sonucMethod() {
    ...
    var sonuc = (0.3669 * number1 * number1 * number1) + (0.03219 * number2) + 0.6041;
    ...
    return (
      <SafeAreaView style={styles.container}>
        <View style={styles.contentWrapper}>
          ...
          <Text style={styles.sampleText}> Ml : {this.state.sonuc}</Text>
        </View>
      </SafeAreaView>
    );
  }

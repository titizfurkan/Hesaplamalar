...
export default class BazalMetabolizmaHizi extends Component {
  constructor(props) {
    super(props);
    this.state = {
      input1: "",
  ...
  sonucMethod() {
    ...
    var sonuc = 66.5 + (13.7 * number1) + (5 * number2) - (6.7 * number3);
      ...
      <SafeAreaView style={styles.container}>
        <View style={styles.contentWrapper}>
         ...
         <TextInput
          ...
          <Text style={styles.sampleText}> BMH  : {this.state.sonuc}</Text>

...
export default class SigaraMaliyetHesaplama extends Component {
  constructor(props) {
    super(props);
    this.state = {
      input1: "",
  ...
  sonucMethod() {
    ...
    var ay = number1 * number2 * 30;
    var yil = number1 * number2 * 360;
    ...
    return (
      <SafeAreaView style={styles.container}>
        <View style={styles.contentWrapper}>
          ...
          <Text style={styles.sampleText}> Ayda  : {this.state.ay}₺</Text>
          <Text style={styles.sampleText}> Yılda : {this.state.yil}₺</Text>
        </View>
      </SafeAreaView>
    );
  }

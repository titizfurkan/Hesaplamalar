...
export default class KinematikVizkoziteHesaplama extends Component {
  constructor(props) {
    super(props);
    this.state = {
      input1: "",
    ...
    return (
      <SafeAreaView style={styles.container}>
        <View style={styles.contentWrapper}>
          ...
          <Text style={styles.sampleText}> Kinematik Vizkozite : {this.state.sonuc}</Text>
        </View>
      </SafeAreaView>
    );
  }

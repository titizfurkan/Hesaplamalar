    ...
    return (
      <SafeAreaView style={styles.container}>
        <View style={styles.contentWrapper}>
          ...
          <Text style={styles.sampleText}> Gerekli Blok Adedi : {this.state.sonuc2}</Text>
          <Text style={styles.sampleText}> Toplam Blok Maliyeti : {this.state.sonuc3}</Text>
        </View>
      </SafeAreaView>
    );
  }
